...
NSString * const scrollViewKeyMJExtensionWillShowTipsKey = @"scrollViewKeyMJExtensionWillShowTipsKey";
...
- (void)setWillShowTips:(BOOL)willShowTips
{
    objc_setAssociatedObject(self, &scrollViewKeyMJExtensionWillShowTipsKey, @(willShowTips), OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}

- (BOOL)willShowTips
{
    return [objc_getAssociatedObject(self, &scrollViewKeyMJExtensionWillShowTipsKey) boolValue];
}

- (void)showTips:(NSString *)tips
{
    self.willShowTips = YES;
}

- (void)pullToRefreshProgrammatically
{
