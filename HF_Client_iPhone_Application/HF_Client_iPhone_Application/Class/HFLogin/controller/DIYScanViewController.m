...
- (void)viewDidLoad {
    ...
    self.navigationItem.title = @"扫描配置";
...
//    [self.navigationController pushViewController:vc animated:YES];
    ...
    if ([result containsString:@"|"]) {
        ...
        [HFNetwork network].ServerAddress = array[1];
        [HFNetwork network].SocketAddress = array[0];
        
         [self.navigationController dismissViewControllerAnimated:YES completion:nil];
        // 发送通知
        [[NSNotificationCenter defaultCenter] postNotificationName:@"DIYScanViewController" object:nil userInfo:nil];
    }
}
